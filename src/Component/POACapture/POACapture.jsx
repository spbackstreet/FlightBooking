                            ...
                            <div style={{ textAlign: "center", overflowY: "scroll", height: "480px" }}>
                                ...
                                <div id="poaview" class="photoPreviewFrame">
                                    ...
                                    <div class="col-6 col-sm-6">
                                        <button type="submit" class="btn jio-btn jio-btn-primary w-100 plan-btn" style={{ "background": "#0D95A2" }} onClick={(e) => previewClicked(e)} disabled={loading}>Preview</button>
                                    </div>
